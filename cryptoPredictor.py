...
_end = today - dt.timedelta(60)#60th day previous to today
...
#Predict today's price based on yesterday
eth_dt = web.DataReader(f'{crypto_currency}-{against_currency}', data_source='yahoo', start=_start, end=(today - dt.timedelta(1)))
#Create a new dataframe
new_df = eth_dt.filter(['Close'])
...
eth_dt2 = web.DataReader(f'{crypto_currency}-{against_currency}', data_source='yahoo', start=_start, end=(today))
print(eth_dt2['Close'])